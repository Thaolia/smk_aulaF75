...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_75_ansi(
        ...
        _______, _______, _______, EURO,    RF_DIAG, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, _______, BRI_DN,  BRI_UP,  _______, _______,
        ...
        LAYOUT_AZ, _______, _______,                          MACRO_TG,                  _______, _______,          SPD_DN,  _______, SPD_UP
    ),
};
