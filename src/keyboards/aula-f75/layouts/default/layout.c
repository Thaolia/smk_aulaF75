 ...
 *
 * Vérification : 80 touches placées sur 90 positions, soit 10 trous --
 * ce qui recoupe exactement les 80 LED nommées « Key: … » et num_leds = 90
 * relevés en direct sur l'appareil. La géométrie est donc établie.
 *
 * Ce qui ne l'est PAS : que la matrice de touches suive la même grille que
 * la matrice LED. Voir kbdef.h.
 */

// clang-format off

#define LAYOUT_75_ansi( \
    K00_0,        K02_0, K03_0, K04_0, K05_0, K06_0, K07_0, K08_0, K09_0, K10_0, K11_0, K12_0, K13_0,        \
    ...
    { K00_0, KC_NO, K02_0, K03_0, K04_0, K05_0, K06_0, K07_0, K08_0, K09_0, K10_0, K11_0, K12_0, K13_0, KC_NO }, \
    { K00_1, K01_1, K02_1, K03_1, K04_1, K05_1, K06_1, K07_1, K08_1, K09_1, K10_1, K11_1, K12_1, K13_1, K14_1 }, \
    { K00_2, K01_2, K02_2, K03_2, K04_2, K05_2, K06_2, K07_2, K08_2, K09_2, K10_2, K11_2, K12_2, K13_2, K14_2 }, \
...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_75_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, FX_PREV, FX_NEXT, _______, _______,          _______, KC_HOME,
