...
/*
 * Mode « compensation AZERTY » du Newmen GM610. Persisté en flash : le clavier
 * repart dans le mode où on l'a laissé.
 *
 * Le clavier est un 60 % ANSI dont les capuchons portent la disposition US
...
/*
 * Annonce visuelle du mode, rendue par l'étage d'éclairage.
 *   demarrage = true  -> annonce longue (~5 s), au démarrage
 *   demarrage = false -> annonce courte, à la bascule
 * `on` vrai éclaire les touches F et R ; faux, les touches U et S.
 */
